      ...
      >
        <svg width="150" height="150" viewBox="0 0 200 200">
          ...
          <line
            ...
            x2="100"
            y2="168"
            stroke={BRAND.inkLegacy}
            strokeWidth="3"
          />
          <circle cx="68" cy="100" r="9" fill={BRAND.inkLegacy} />
          <circle cx="71" cy="97" r="2.5" fill={BRAND.brand} />
          <path
            d="M 58 82 L 80 82"
            stroke={BRAND.inkLegacy}
            strokeWidth="4"
          ...
          <path
            ...
            fill="none"
          />
          <ellipse cx="138" cy="102" rx="11" ry="8" fill={BRAND.inkLegacy} />
          <circle cx="144" cy="100" r="3" fill={BRAND.white} />
          <path
          ...
          <path
            ...
            fill="none"
          />
          <circle cx="148" cy="142" r="3" fill={BRAND.mascotTongue} />
        </svg>
      </div>
    ),
    { ...size },
